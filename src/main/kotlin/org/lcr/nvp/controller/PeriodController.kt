...
class PeriodController(
    ...
    @Operation(summary = "기수 생성", description = "새로운 기수 정보를 시스템에 등록합니다.")
    @PostMapping
    ...
    @Operation(summary = "전체 기수 목록 조회", description = "시스템에 등록된 모든 기수 목록을 조회합니다.")
    @GetMapping
    ...
    @Operation(summary = "기수 정보 수정", description = "특정 기수의 정보를 수정합니다.")
    @PutMapping("/{periodId}")
    fun updatePeriod(
    ...
    @Operation(summary = "기수 삭제", description = "특정 기수를 삭제합니다. 해당 기수에 소속된 회원이 없어야 삭제 가능합니다.")
    ...
    @Operation(summary = "현재 활동 기수 설정", description = "특정 기수를 현재 활동 기수로 설정합니다. 기존의 현재 기수는 자동으로 해제됩니다.")
